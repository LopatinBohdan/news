        ...
        <div class="row mb-1">
            ...
            <div class="col-md-8 col-12">
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex">
                        <button type="button" class="decrement btn btn-danger"
                            onclick="decrementValue('personAmountInput')"><i class="fa-solid fa-circle-minus"></i></button>
                        <input type="number" id="personAmountInput" name="personAmount" class="form-control"
                            placeholder="persons amount" value="1" min="1" max="100">
                        <button type="button" class="increment btn btn-success"
                            onclick="incrementValue('personAmountInput')"><i class="fa-solid fa-circle-plus"></i></button>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="d-flex">
                        <button type="button" class="decrement btn btn-danger"
                            onclick="decrementValue('roomAmountInput')"><i class="fa-solid fa-circle-minus"></i></button>
                        <input type="number" id="roomAmountInput" name="roomAmount" class="form-control"
                            placeholder="rooms amount" value="1" min="1" max="100">
                        <button type="button" class="increment btn btn-success"
                            onclick="incrementValue('roomAmountInput')"><i class="fa-solid fa-circle-plus"></i></button>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-4 col-12">
                <div id="dropArea">
                    ...
                    <input type="file" id="fileInput" name="appartment_photo[]" accept="image/*" multiple
                        style="display: none;">
                </div>
                    ...
                    @foreach ($comforts as $comfort)
                        @if ($comfort->categoryId == $category->id)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="{{$comfort->id}}" name="{{$comfort->id}}">
                                <label class="form-check-label" for="">{{$comfort->title}}</label>
                            </div>
                        @endif
                    @endforeach
